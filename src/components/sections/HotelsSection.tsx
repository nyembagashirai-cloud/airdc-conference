...
const hotels = [
  {
    ...
    description: "Harare's most prestigious historic hotel, offering world-class luxury in the heart of the city. Official conference partner hotel.",
    phone: "+263 4 707 721",
  ...
  },
  {
    ...
    phone: "+263 4 795 611",
    website: "https://www.ihg.com/holidayinn/harare",
    bookingUrl: "https://www.ihg.com/holidayinn/harare",
    imageUrl: null,
    featured: false,
    amenities: ["Free WiFi", "Parking", "Restaurant"],
    rates: [
